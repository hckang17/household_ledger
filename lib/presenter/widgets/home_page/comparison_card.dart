// """ MVVM 계층: View / home_page """
// """ 역할: 홈 화면의 전월동기 소비 비교 카드 표시 """
...
class ComparisonCard extends StatefulWidget {
  ...
  final ExpenseComparisonResult result;
...
class _ComparisonCardState extends State<ComparisonCard> {
  ...
  Widget build(BuildContext context) {
    final ExpenseComparisonResult result = widget.result;
    final Map<String, String> strings = widget.strings;
    final String currency = widget.currency;

    final Color accentColor = result.moreSpent
    ...
    final List<_CompMsg> categoryMsgs = result.categoryDifferences.map((
