...
class AppBackgroundSection extends StatelessWidget {
  const AppBackgroundSection({
  ...
  Widget build(BuildContext context) {
    return BootstrapSectionCard(
      child: Column(
        ...
        children: <Widget>[
          Text(
            _text('travelGradientSettingsTitle', '앱 배경'),
            style: Theme.of(
              context,
          ...
          Text(
            _text('travelGradientSettingsDescription', '앱 전체에 사용할 배경을 선택하세요.'),
            style: Theme.of(
              context,
                    ...
                    <TravelGradientPalette?>[
                      ...
                      return SizedBox(
                        ...
                        child: _PaletteChoice(
                          palette: palette,
                          label: palette == null
                              ? _text('appBackgroundSolid', '기본 단색')
                              : _text(palette.labelKey, palette.code),
        ...
        child: InkWell(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: palette == null ? const Color(0xFFF4F7FB) : null,
