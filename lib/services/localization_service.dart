...
class LocalizationService {
  ...
  static const Map<String, String> fallbackStrings = <String, String>{
    ...
    'systemTagDiningLateNight': '야식',
    'systemTagDiningCompany': '회식',
    'systemTagPaymentCash': '현금',
    'systemTagPaymentCreditCard': '신용카드',
    ...
    'metadataCodeExhausted': '추가할 수 있는 태그 개수를 초과했습니다.',
    'metadataTagNameLabel': '카테고리 명',
    'metadataTagNameHint': '카테고리 명을 입력해주세요',
    'metadataTagNameRequired': '카테고리 명은 빈칸으로 저장할 수 없습니다.',
    'metadataTagNameDuplicate': '같은 구분에 이미 존재하는 카테고리 명입니다.',
    'settingsTitle': '환경설정',
    'pushSettingsTitle': '푸시 알림',
    'pushMasterTitle': '푸시 알림 받기',
    'pushMasterDescription': '가계부 기록을 위한 예약 알림을 받습니다.',
    'pushPermissionDenied': '기기 설정에서 알림 권한을 허용해주세요.',
    'pushCategoryDaily': '매일',
    'pushCategoryDailyDescription': '매일 13시와 20시에 기록을 알려드려요.',
    'pushCategoryFixedExpense': '고정비',
    'pushCategoryFixedExpenseDescription': '매달 15일 고정비 입력을 알려드려요.',
    'pushCategorySalary': '급여',
    'pushCategorySalaryDescription': '설정한 급여일에 수입 입력을 알려드려요.',
    'pushCategoryOther': '기타 알림',
    'pushCategoryOtherDescription': '매달 1일과 앱을 2일간 열지 않았을 때 알려드려요.',
    'pushSalaryDayLabel': '급여일',
    'pushDayOfMonth': '매달 {day}일',
    'metadataTitle': '태그 관리',
    'addTag': '태그 추가',
