...
class LocalizationService {
  ...
  static const Map<String, String> fallbackStrings = <String, String>{
    ...
    'travelModeTitle': '여행 모드',
    'travelModeOffDescription': '여행을 선택하면 신규 지출에 자동 적용됩니다.',
    'travelSelectTitle': '기록할 여행 선택',
    'travelEmptyMessage': '저장된 여행이 없습니다. 새 여행을 추가해주세요.',
    'travelAddButton': '새 여행 추가',
    'travelManagementTitle': '여행정보 관리',
    'travelAddTitle': '새 여행',
    ...
    'travelNoteLabel': '메모',
    'travelValidationMessage': '여행 이름, 기간과 예산을 올바르게 입력해주세요.',
    'travelExpenseTripLabel': '여행 이름',
    'travelUnassignedLabel': '미지정',
    'travelActiveLabel': '사용 중',
    'travelArchiveButton': '보관',
    'travelRestoreButton': '복원',
    'travelLoadError': '여행정보를 불러오지 못했습니다.',
    'sideBarTravelGroup': '여행',
    'sideBarTravelManagement': '여행정보 관리',
  };
